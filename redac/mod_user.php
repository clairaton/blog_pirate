...
$firstname = isset($_POST['firstname']) ? $_POST['firstname'] : $user['user_firstname'];
$lastname = isset($_POST['lastname']) ? $_POST['lastname'] : $user['user_lastname'];
$email = isset($_POST['email']) ? $_POST['email'] : $user['user_email'];
$status = isset($_POST['status']) ? intval($_POST['status']) : $user['user_status'];
...
if (!empty($_POST)) {
	...
	if (empty($errors)) {
		...
		$query = $db->prepare('UPDATE user SET user_firstname = :firstname, user_lastname = :lastname, user_email = :email, user_status = :status WHERE user_id = :id');
